...
"[project]/frontend/app/organizations/[uuid]/enterprise-reporting/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EnterpriseReportingPage({ params }) {
    ...
    const fetchData = async ()=>{
        setLoading(true);
        try {
            const projectsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/v1/projects/?organisation_id=${uuid}`);
            const projectsData = projectsResponse.data;
            setProjects(projectsData);
            const allTestCases = [];
            for (const project of projectsData){
                const testCasesResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/v1/test_cases/?project_id=${project.id}`);
                allTestCases.push(...testCasesResponse.data);
            }
            setTestCases(allTestCases);
        } catch (error) {
            console.error('Failed to fetch reporting data:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Failed to load reporting data');
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=frontend_cd1d1058._.js.map