module.exports = [
"[project]/frontend/app/organizations/new/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CreateOrganizationPage() {
    ...
    const { user, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$auth$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        setNameError(false);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/v1/organisations/', {
                name: name.trim(),
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Organization created successfully!');
            // Redirect to projects with organization UUID
            router.push(`/organizations/${response.data.id}/projects`);
        } catch (error) {
            console.error('Error creating organization:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.response?.data?.detail || 'Failed to create organization');
            setLoading(false);
        }
    };
...
//# sourceMappingURL=_fc6fbe6c._.js.map