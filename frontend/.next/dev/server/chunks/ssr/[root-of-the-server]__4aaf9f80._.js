...
api.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/api/v1/auth/refresh`, refreshToken ? {
...
function AuthProvider({ children }) {
    ...
    const checkAuth = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/v1/auth/me`);
    ...
    const login = async (email, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/api/v1/auth/login`, {
                email,
                password
            });
            ...
            const userResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/v1/auth/me`);
            setUser(userResponse.data);
            // Fetch organizations to determine redirect
            try {
                const orgsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/v1/organisations/`);
    ...
    const signup = async (email, username, password, fullName)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/api/v1/auth/signup`, {
                email,
                username,
                password,
                full_name: fullName
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4aaf9f80._.js.map