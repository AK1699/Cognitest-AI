...
function AuthProvider({ children }) {
    ...
    const checkAuth = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/v1/auth/me`);
    ...
    const login = async (email, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/api/v1/auth/login`, {
                email,
                password
            });
            // Tokens are set as httpOnly cookies by the server, no need to store in localStorage
            // Fetch user data after successful login
            const userResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/v1/auth/me`);
            setUser(userResponse.data);
            // Fetch organizations to determine redirect
            try {
                const orgsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/v1/organisations/`);
    ...
    const signup = async (email, username, password, fullName)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/api/v1/auth/signup`, {
                email,
                username,
                password,
                full_name: fullName
...
//# sourceMappingURL=frontend_a2feae55._.js.map