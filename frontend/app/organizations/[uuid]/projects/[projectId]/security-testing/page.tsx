            ...
            <div className="border-b border-gray-300 bg-gradient-to-r from-slate-50 via-gray-50 to-stone-50">
                <div className="px-6 py-3 flex items-center gap-4">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-t-md transition-colors ${activeModule === 'overview'
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-t-md transition-colors ${activeModule === 'url'
                            ? 'text-primary bg-white border-b-2 border-primary shadow-sm'
                            : 'text-gray-600 hover:text-primary hover:bg-white/50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-t-md transition-colors ${activeModule === 'repo'
                            ? 'text-primary bg-white border-b-2 border-primary shadow-sm'
                            : 'text-gray-600 hover:text-primary hover:bg-white/50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-t-md transition-colors ${activeModule === 'vapt'
                            ? 'text-primary bg-white border-b-2 border-primary shadow-sm'
                            : 'text-gray-600 hover:text-primary hover:bg-white/50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-t-md transition-colors ${activeModule === 'policy'
                            ? 'text-primary bg-white border-b-2 border-primary shadow-sm'
                            : 'text-gray-600 hover:text-primary hover:bg-white/50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-t-md transition-colors ${activeModule === 'compliance'
                            ? 'text-primary bg-white border-b-2 border-primary shadow-sm'
                            : 'text-gray-600 hover:text-primary hover:bg-white/50'
                            }`}
                    >
