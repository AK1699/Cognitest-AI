            ...
            >
                ...
                <div className="p-4 border-b border-gray-200 overflow-hidden">
                    <div className="flex items-center gap-3">
                        ...
                        {!isCollapsed && (
                            <div className="flex-1 min-w-0">
                                <h3 className="text-sm font-semibold truncate text-gray-900">Performance</h3>
                            </div>
                        )}
                    </div>
                    {!isCollapsed && (
                ...
                <nav className="flex-1 p-3 overflow-y-auto overflow-x-hidden">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-1">
                            {!isCollapsed && <div className="text-[10px] font-bold text-gray-500 uppercase mb-2 px-3 tracking-widest">Main Analysis</div>}
                            {[
                                { id: 'overview', label: 'Overview', icon: Gauge },
                                { id: 'tests', label: 'Saved Tests', icon: List },
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all border-2 ${activeModule === item.id
                                ...
                                >
                                    <item.icon className={`w-5 h-5 flex-shrink-0 ${activeModule === item.id ? 'scale-110' : ''}`} />
                        ...
                        {/* Load Testing */}
                        <div className="space-y-1">
                            {!isCollapsed && <div className="text-[10px] font-bold text-gray-500 uppercase mb-2 px-3 tracking-widest">Load Testing</div>}
                            {[
