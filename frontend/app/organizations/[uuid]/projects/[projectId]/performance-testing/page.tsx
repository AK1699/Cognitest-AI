                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                  ...
                  <div className="md:col-span-12">
                    <Label
                      ...
                      className="text-[10px] font-bold uppercase tracking-widest text-gray-700 mb-2 block"
                    >
                      Target URL
                    </Label>
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className="pl-10 h-12 text-base font-medium bg-white border-gray-300 focus:bg-white focus:border-teal-700 focus:ring-teal-700/10 transition-all rounded-xl shadow-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-12 bg-gray-50 p-4 rounded-2xl border border-gray-300">
                    <Label className="text-[10px] font-bold text-gray-700 uppercase tracking-widest mb-3 block">
                      Device Profile
                    </Label>
                    <RadioGroup
                      defaultValue="mobile"
                    ...
                    <div className="md:col-span-12">
                      ...
                      <div className="relative group">
                        ...
                        <Input
                          ...
                          className="pl-10 h-12 text-base font-medium bg-white border-gray-300 focus:bg-white focus:border-purple-700 focus:ring-purple-700/10 transition-all rounded-xl shadow-sm"
                        />
                      </div>
                    </div>
                      ...
                      {loadTestType === "simple" ? (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div>
                            ...
                            >
                              <SelectTrigger className="h-12 rounded-xl bg-white border-gray-300 shadow-sm text-sm font-bold">
                          ...
                          <div>
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className={cn(
                                  "pl-10 h-12 text-sm font-bold bg-white border-gray-300 rounded-xl shadow-sm",
                                ...
                                <div className="flex-1 grid grid-cols-2 gap-3">
                                  <div className="relative">
                                    ...
                                    <Input
                                      ...
                                      className="pl-8 h-10 text-xs font-bold bg-white border-gray-200 rounded-lg"
                  ...
                  <div className="md:col-span-12">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className="pl-10 h-12 text-base font-medium bg-white border-gray-300 focus:bg-white focus:border-orange-700 focus:ring-orange-700/10 transition-all rounded-xl shadow-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-12">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        placeholder="https://api.example.com/endpoint"
                        className="pl-10 h-12 text-base font-medium bg-white border-gray-300 focus:bg-white focus:border-red-700 focus:ring-red-700/10 transition-all rounded-xl shadow-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-12">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        placeholder="https://api.example.com/endpoint"
                        className="pl-10 h-12 text-base font-medium bg-white border-gray-300 focus:bg-white focus:border-indigo-700 focus:ring-indigo-700/10 transition-all rounded-xl shadow-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-12">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        id="volume-url"
                        placeholder="https://api.example.com/endpoint"
                        className="pl-10 h-12 text-base font-medium bg-white border-gray-300 focus:bg-white focus:border-blue-700 focus:ring-blue-700/10 transition-all rounded-xl shadow-sm"
                      />
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 h-12 text-sm font-bold bg-white border-gray-300 rounded-xl shadow-sm"
                        />
                      </div>
                    </div>
                  ...
                  <div className="md:col-span-12">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        id="scalability-url"
                        placeholder="https://api.example.com/endpoint"
                        className="pl-10 h-12 text-base font-medium bg-white border-gray-300 focus:bg-white focus:border-green-700 focus:ring-green-700/10 transition-all rounded-xl shadow-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-12">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        id="capacity-url"
                        placeholder="https://api.example.com/endpoint"
                        className="pl-10 h-12 text-base font-medium bg-white border-gray-300 focus:bg-white focus:border-cyan-700 focus:ring-cyan-700/10 transition-all rounded-xl shadow-sm"
                      />
                    </div>
                  </div>
