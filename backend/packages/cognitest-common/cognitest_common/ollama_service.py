...
class OllamaService:
    ...
    def __init__(self, settings: Any):
        ...
        self.main_model = getattr(settings, "OLLAMA_MODEL", "llama3:8b")
        self.helper_model = getattr(settings, "OLLAMA_HELPER_MODEL", "mistral")
...
def get_ollama_service(settings: Any) -> OllamaService:
    """
    ...
    if _ollama_service is None:
        _ollama_service = OllamaService(settings)
