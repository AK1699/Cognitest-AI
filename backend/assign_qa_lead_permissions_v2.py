...
Using actual permission names from the database.
"""
...
async def assign_qa_lead_permissions():
    ...
    async with async_session() as session:
        # QA Lead permissions - using actual permission names from database
        # QA Lead: Manage test cases, assign tasks, and approve AI fixes
        qa_lead_permissions = [
            # Project access
            "project_read_access",
