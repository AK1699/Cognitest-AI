...
async def verify_reset_code(request: Request, response: Response, body: VerifyResetCodeRequest, db: AsyncSession = Depends(get_db)):
    """
...
@limiter.limit("5/minute")
async def reset_password(request: Request, response: Response, body: ResetPasswordRequest, db: AsyncSession = Depends(get_db)):
    """
