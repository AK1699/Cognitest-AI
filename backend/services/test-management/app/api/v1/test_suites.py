...
from ...models.test_plan import TestPlan, TestPlanType
...
def _parse_suite_hid(hid: str) -> Optional[tuple[int, int]]:
...
async def create_test_suite(
    ...
    try:
        from ...services.human_id_service import HumanIdAllocator, format_suite
...
async def ai_generate_test_suite(
    ...
    try:
        from ...services.test_plan_service import get_test_suite_service
        from app.models.test_plan import GenerationType

        # Get test plan service
        test_plan_service = get_test_suite_service()
