from sqlalchemy import Column, String, DateTime, JSON, Text, ForeignKey, Integer, Enum as SQLEnum, Boolean
...
from .test_plan import GenerationType
...
class TestCase(Base):
    ...
    human_id = Column(String(96), nullable=True, index=True)
