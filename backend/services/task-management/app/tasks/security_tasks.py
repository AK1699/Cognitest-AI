...
def run_url_scan(
    ...
    from ..services.security_scanning_service import SecurityScanningService
    from ..services.external_scanners import ExternalScannerFactory, ScannerType
...
def run_repo_scan(
    ...
    from ..services.security_scanning_service import SecurityScanningService
    from ..services.external_scanners import ExternalScannerFactory, ScannerType
    from ..services.entropy_analyzer import EntropyAnalyzer
...
def generate_compliance_report(
    ...
    from ..core.deps import AsyncSessionLocal
    from ..services.security_scanning_service import SecurityScanningService
    from ..models.security import ComplianceFramework
...
def process_scheduled_scans() -> Dict[str, Any]:
    ...
    """
    from ..core.deps import AsyncSessionLocal
    from ..models.security import ScanSchedule
