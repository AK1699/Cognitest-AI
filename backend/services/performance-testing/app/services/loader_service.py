...
class LoaderIOService:
    ...
    async def verify_domain(self, domain: str) -> Dict[str, Any]:
        ...
        Loader.io requires domain verification before testing
        
        Args:
            domain: Domain to verify (e.g., 'api.example.com')
    ...
    async def create_test(
        ...
        Returns:
            Test details including result_id for polling
        """
    ...
    async def get_test_status(self, result_id: str) -> Dict[str, Any]:
        ...
        Args:
            result_id: Result ID from create_test
